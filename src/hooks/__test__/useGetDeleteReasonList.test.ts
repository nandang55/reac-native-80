...
import useGetDeleteReasonList from '../useGetDeleteReasonList';
...
describe('user get delete reason list', () => {
  it('should fire useGetDeleteReasonList', async () => {
    const { result, waitFor } = renderHook(() => useGetDeleteReasonList({}), {
      wrapper
    });
