...
import useGetCountWishlist from '../useGetCountWishlist';
...
describe('user get count wishlist', () => {
  it('should fire useGetCountWishlist', async () => {
    const { result, waitFor } = renderHook(() => useGetCountWishlist({}), {
      wrapper
    });
