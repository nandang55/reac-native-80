...
import useGetPrimaryShippingAddress from '../useGetPrimaryShippingAddress';
...
describe('user get primary shipping address', () => {
  it('should fire useGetPrimaryShippingAddress and return primary address', async () => {
    const { result, waitFor } = renderHook(() => useGetPrimaryShippingAddress({}), {
      wrapper
    });
